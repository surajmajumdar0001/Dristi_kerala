...
public class EPostQueryBuilder {
    private final String BASE_APPLICATION_QUERY = "SELECT process_number, tenant_id, task_number, tracking_number, pincode, address, delivery_status, remarks, additionalDetails, row_version, booking_date, received_date, createdBy, lastModifiedBy, createdTime, lastModifiedTime ";
...
//    private final String ORDER_BY = " ORDER BY cl.case_date, cl.judge_id, cl.hearing_type";
    ...
    public String getEPostTracker(EPostTrackerSearchCriteria searchCriteria, List<String> preparedStmtList){
