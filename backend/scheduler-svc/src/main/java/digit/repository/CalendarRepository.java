...
public class CalendarRepository {
    ...
    public List<JudgeCalendarRule> getJudgeRule(JudgeAvailabilitySearchCriteria criteria) {
    ...
    public List<JudgeCalendarRule> getJudgeRule(CalendarSearchCriteria criteria) {
        List<String> preparedStmtList = new ArrayList<>();
        String query = queryBuilder.getJudgeCalendarQuery(criteria, preparedStmtList);
        log.debug("Final query: " + query);
        return jdbcTemplate.query(query, preparedStmtList.toArray(), rowMapper);
