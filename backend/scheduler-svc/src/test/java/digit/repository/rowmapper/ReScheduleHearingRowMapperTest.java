...
public class ReScheduleHearingRowMapperTest {
    ...
    public void testMapRow_withAllFieldsPresent() throws Exception {
        ...
        when(resultSet.getString("action_comment")).thenReturn("comment");
        ...
        when(objectMapper.readValue("[\"2023-07-01\",\"2023-07-02\"]", List.class)).thenReturn(suggestedDays);
        when(objectMapper.readValue("[\"2023-07-03\",\"2023-07-04\"]", List.class)).thenReturn(availableDays);
