...
public class HearingRepositoryTest {
    ...
    private HearingSearchCriteria hearingSearchCriteria;
    private List<ScheduleHearing> scheduleHearings;
    private List<AvailabilityDTO> availabilityDTOs;

    @BeforeEach
    public void setUp() {
        hearingSearchCriteria = new HearingSearchCriteria();
    ...
    public void testGetHearings_Success() {
        ...
        when(queryBuilder.getHearingQuery(any(HearingSearchCriteria.class), any(List.class), anyInt(), anyInt())).thenReturn("SELECT * FROM hearings");
        ...
        verify(queryBuilder, times(1)).getHearingQuery(any(HearingSearchCriteria.class), any(List.class), anyInt(), anyInt());
    ...
    public void testGetAvailableDatesOfJudges_Success() {
        List<Object> preparedStmtList = new ArrayList<>();
        when(queryBuilder.getJudgeAvailableDatesQuery(any(HearingSearchCriteria.class), any(List.class))).thenReturn("SELECT * FROM availability");
        ...
        assertEquals(1, result.size());
        verify(queryBuilder, times(1)).getJudgeAvailableDatesQuery(any(HearingSearchCriteria.class), any(List.class));
